            ...
            <section id="content">
                <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 m-b-20">
                                    <div class="form-group fg-line">
                                        <label>Name</label>
                                        <input type="text" class="form-control" placeholder="eg:Akosua Boatemaa" required="required">
                                    </div>
                                </div>
                                  ...
                                  <div class="col-sm-3 m-b-20">
                                    <div class="form-group fg-line">
                                        ...
                                        <input type="text" class="form-control" placeholder="eg:Boatemaa1" required="required">
                                    </div>
                                </div>
                                 ...
                                 <div class="col-sm-3 m-b-20">
                                    <div class="form-group fg-line">
                                        <label>Email</label>
                                        <input type="email" class="form-control" placeholder="eg:ba@gmail.com" required="required">
                                    </div>
                                </div>
                                 ...
                                 <div class="col-sm-3 m-b-20">
                                    <div class="form-group fg-line">
                                        <label>Contact #</label>
                                        <input type="text" class="form-control" placeholder="eg:0547343887" required="required">
                                    </div>
                                </div>
                                 ...
                                 <div class="col-sm-12  m-b-25">
                                    <input type="submit" name="add" class="col-sm-6 col-sm-offset-3 btn bgm-teal">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2>
                                <small>Manage Tenants data here
                                </small>
                            </h2>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <?php 
                                        $sql =mysqli_query($con,"SELECT * FROM `user` WHERE `uType`='1'");
        ...
        <script type="text/javascript">
            $(document).ready(function() {
             ...
             $('#sa-warning').click(function(){
                swal({   
                    title: "Set Inactive?",   
                    text: "Are you sure you want to set inactive?",   
                    type: "warning",   
                    showCancelButton: true,   
                    confirmButtonText: "Yes, Set Inactive!",
                }).then(function(){

                        swal("Done!", "Inactivation done .", "success"); 
                });
            });

...
<head>
        ...
        <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v5.0&appId=1634415043264210&autoLogAppEvents=1"></script>
    </head>
    ...
    <body>
            ...
            <div class="lc-block toggled" id="l-login">
                ...
                <div class="lcb-navigation">
                    <a src="#" data-ma-action="login-switch" data-ma-block="#l-register"><i class="zmdi zmdi-plus"></i> <span>Register</span></a>
                    <a src="#" data-ma-action="login-switch" data-ma-block="#l-forget-password"><i>?</i> <span>Forgot Password</span></a>
                </div>
                </form>
            </div>
            ...
            <div class="lc-block" id="l-register">
                ...
                <form name="rform" method="POST" action="php/functions.php">
                    ...
                    <div class="input-group m-b-20">
                        <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
                        <div class="fg-line">
                            <input type="text" class="form-control" id="runame" name="runame" placeholder="Username" required="true">
...
<!-- 
                    ...
                    <div class="input-group m-b-20">
                        <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
                        <div class="fg-line">
                             <select class="selectpicker" data-live-search="true" name="uType" required="required">
                                <option value="agent">Agent</option>
                                <option value="po">Property Owner/Landlord</option>
                             </select>
                        </div>
                    </div>
                ...
                <div class="lcb-navigation">
                    <a src="#" data-ma-action="login-switch" data-ma-block="#l-login"><i class="zmdi zmdi-long-arrow-right"></i> <span>Sign in</span></a>
                    <a src="#" data-ma-action="login-switch" data-ma-block="#l-forget-password"><i>?</i> <span>Forgot Password</span></a>
                </div>
            ...
            <div class="lc-block" id="l-forget-password">
                <div class="lcb-form">
                    ...
                    <a src="#" class="btn btn-login btn-success btn-float" id="forgotBtn"><i class="zmdi zmdi-check"></i></a>
                </div>
        ...
        <script type="text/javascript">
            $("#runame").blur(function(){
                   username =$("#runame").val();
                   if(username!=""){
                      $.post("php/ajax.php",{status:"getUname",uname:username},function(data){
                        console.log(data)
                        if(data=="Exists"){
                           $(".text-danger").html("This username exists please change it");
                           $("#runame").focus();
